...
# custom_imports = dict(
#     imports=['datasets/FewShotCocoDataset'],
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='SGD', lr=0.001, momentum=0.09, weight_decay=0.0001))  # adjusted lr and momentumz
...
work_dir = './outputs/CondInst/test_few_shot/'
