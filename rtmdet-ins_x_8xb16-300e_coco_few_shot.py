...
custom_imports = dict(
    ...
    imports=[
        'configs/FewShotRTMDetInsSepBNHead',
        'losses/FewShotDiceLoss',
        'datasets/FishDataset'
    ],
...
model = dict(
    ...
    neck=dict(
        ...
        act_cfg=dict(type='SiLU', inplace=True)),
    bbox_head=dict(
        type='FewShotRTMDetInsSepBNHead',
        num_classes=17,
        in_channels=320,
        stacked_convs=2,
        share_conv=True,
        ...
        loss_mask=dict(
            type='FewShotDiceLoss', loss_weight=2.0, eps=5e-06, reduction='mean')),
    train_cfg=dict(
