...
from mmdet.structures.bbox.transforms import bbox2roi, bbox2result
...
class MetaRCNNRoIHead(StandardRoIHead):
    ...
    Args:
        aggregation_layer (ConfigType): Config of `aggregation_layer`.
            Default: None.
    """
    ...
    def __init__(self,
        ...
        self.aggregation_layer = MODELS.build(copy.deepcopy(aggregation_layer))
